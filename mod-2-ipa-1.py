...
def savings(gross_pay, tax_rate, expenses):
    ...
    take_home_pay = gross_pay - int(gross_pay * tax_rate) - expenses
    return take_home_pay

savings(67_852, .18, 30_567)
...
def body_mass_index(weight, height):
    ...
    # convert pound to kilogram (1 pound = 0.453592 kilogram)
    weight_in_kg = weight * 0.453592
    
    # convert foot to meter (1 foot = 0.3048 meter) and inch to meter (1 inch = 0.0254 meter)
    height_in_m = (height[0] * 0.3048) + (height[1] * 0.0254)
    
    body_mass_index = weight_in_kg / height_in_m**2
    return body_mass_index

body_mass_index(165, [5,4])
